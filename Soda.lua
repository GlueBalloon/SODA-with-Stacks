...
function Soda.rebuild()
    local state = Soda.beforeRebuild and Soda.beforeRebuild() or nil
    hideKeyboard()
    ...
    Layout.applyFont()
    Soda.rootBuilder{}
    if Soda.afterRebuild then Soda.afterRebuild(state) end
    Soda.pendingRebuild = false
end
